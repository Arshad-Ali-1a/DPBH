...
//             // pattern.classList.add("dark-pattern-msg");
...
//             }
//             // result.remove(result.querySelector('.dark-pattern-msg'));
      ...
      if(node.textContent === searchText && node.nodeType !== 3){
        ...
        return;
          ...
          if (node.nodeValue.includes(searchText)) {
              ...
              parent.innerHTML = parent.innerHTML.replace(regex, `<span title="${"Pattern Type: " + patternType}" style="background-color: red;z-index: 10">$&</span>`);
          }
      } else {
